...
const TodoProvider = ({children}) => {
    ...
    return (
        <TodoContenxt.Provider value={{todoList, getTodoList, addTodo, updatTodo, deleteTodo}}>
            {children}
...
// 최종적으로 구현할려는 것 state, get, add, update, delete --> 전역으로 사용해서 어디서든 꺼내려하는 것
// hoc를 활용한 로그인 없으면 팅겨져 나오게 만드는게 최종 목표
