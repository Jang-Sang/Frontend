/*
모든 페이지에서 
자주 재사용되는 컴포넌트 (select, button, input) => 공용 컴포넌트 (src/component)
디자이너와 협업 -> 컴포넌트 공유 -> UI 인벤토리 -> storybook

디자이너가 이미 만ㄷ늘어진 컴포넌트를 기반으로 디자인하여
...
const JWButton = ({ variant, size, shape, children, ...rest }) => {
